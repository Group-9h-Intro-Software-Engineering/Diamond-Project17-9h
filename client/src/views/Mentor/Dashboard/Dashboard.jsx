          ...
          {classrooms.map((classroom) => (
            <div key={classroom.id} id='dashboard-class-card'>
              <div id='card-left-content-container'>
                ...
                <p id='card-unit'><strong>Unit:</strong> Earth</p> {/* TODO: Add unit display */}
                <p id='active-lesson-module'><strong>Lesson Standard:</strong> Fossil Fuels</p> {/* TODO: Add lesson standard display */}
